using MadereraMancino.Application.Dtos.Identity.User;
using MadereraMancino.Application.Dtos.Login;
using MadereraMancino.Entities.MicrosoftIdentity;
using MadereraMancino.Services.AuthServices;
using MadereraMancino.WebAPI.Configurations;
